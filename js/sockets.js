...
socket.on('incomingMessage', function (data) {
    ...
    if (data.message.conversation_id == Chat.party.conversation_id) {
        ...
        $('.conversation').append('<div class="message me"><div class="time">' + _stringifyDate(new Date(message.created_at)) + '</div><div class="text">' + message.message + '</div><div class="dot"></div></div>');
    }
});
